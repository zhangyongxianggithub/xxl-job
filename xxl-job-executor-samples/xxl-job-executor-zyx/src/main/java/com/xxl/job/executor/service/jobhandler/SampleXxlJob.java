...
public class SampleXxlJob {
    ...
    public void demoJobHandler() throws Exception {
        ...
        logger.info("demoJobHandler execute: " + LocalDateTime.now());
        for (int i = 0; i < 5; i++) {
    ...
    public void httpJobHandler() throws Exception {
        ...
        for (String httpParam : httpParams) {
            ...
            if (httpParam.startsWith("method:")) {
                method = httpParam.substring(httpParam.indexOf("method:") + 7)
                        .trim().toUpperCase();
            }
            if (httpParam.startsWith("data:")) {
                data = httpParam.substring(httpParam.indexOf("data:") + 5)
                        .trim();
            }
        }
        ...
        try {
            ...
            if (statusCode != 200) {
                throw new RuntimeException(
                        "Http Request StatusCode(" + statusCode + ") Invalid.");
            }
